...
namespace Infrastructures.ApplicationServices.WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                //var xmlDocPath = Path.Combine(AppContext.BaseDirectory, "EndPoints.ShortUrlApi.xml");
        ...
        public static IApplicationBuilder UseSwaggerAndUI(this IApplicationBuilder app)
        {
            ...
            {
                options.Route
                late = "api-docs/{documentName}/swagger.json";
            }*/);
